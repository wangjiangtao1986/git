...
//		var oneTbar = Ext.create('Ext.toolbar.Toolbar',{
//			top : 30,
//			items : [
...
//		var twoTbar = Ext.create('Ext.toolbar.Toolbar',{
//			xtype:"container",  
//			border:false,  
//			items : [{
//			     //tbar第一行工具栏  
...
//			tbar : [twoTbar]
			tbar:{
				...
				items:[{
				     ...
				     xtype:"toolbar",  
				     items : [
								 '-', this.moreBtn, '-', this.dayBtn, '-',
								this.weekBtn, '-', this.monthBtn, '-', this.refreshBtn, '-'
							]
				},{  
				     //tbar第二行工具栏  
				     xtype:"toolbar",  
