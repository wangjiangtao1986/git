			...
			initComponent : function() {
			   ...
			   this.ceditor=Ext.create('Ext.ux.calendar.editor.CalendarEditor',{
				...
				/*
				 ...
				 this.southPanel=Ext.create('Ext.ux.calendar.SouthPanel',{
							ehandler : this.ehandler
						})
...
//						westPanel
				...
				Ext.apply(this, {
							layout : 'border',
							items : [this.southPanel,this.calendarContainer]
						})
				...
				*/
				this.southPanel.relayEvents(this.calendarContainer,['changedate']);
