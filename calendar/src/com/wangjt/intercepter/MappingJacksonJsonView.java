...
import org.springframework.web.servlet.view.AbstractView;
  ...
  public class MappingJacksonJsonView extends AbstractView {
  	...
  	protected void renderMergedOutputModel(Map<String, Object> model,
  		...
  		boolean _page = false;
  		if(request.getRequestURI().startsWith(request.getContextPath() + "/listPage/") && null!=PageContextHolder.getPageInfo() && "true".equals(PageContextHolder.getPageInfo().getRefreshAll())){
  			_page = true;
  		}
  		
  		Object value = filterModel(model, _page);
  	 ...
  	 */
  	protected Object filterModel(Map<String, Object> model, boolean _page) {
		...
		if(_page){
			result.put("total", PageContextHolder.getPageInfo().getTotalRows());
		}
